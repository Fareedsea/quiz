...
const quiz:{
    ...
    },
    {
        name:"question_2",
        type:"list",
        message:"What of the following characters is commonly allowed in variable names in Typescript?",
        choices:["$","@","#","&"]
    },
    {
        name:"question_3",
    ...
    },
    {
        name:"question_5",
        type:"list",
        message:"Which method of inquirer.js used to start to prompt interface and receive user input?",
