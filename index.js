...
console.log(chalk.italic.bold.green("=========================== QUIZ START ==============================="));
...
console.log(chalk.italic.blue(`\n\t ====== ${chalk.bold.bgYellowBright(questions.Name)}: Score ${chalk.bold.bgYellowBright(result)} out of ${chalk.bold.bgYellowBright(5)} =======`));
